const translations = {    en: {
        ...
        about: {
            ...
            description2: "Uzmanlığımız, yapısal tasarım ve detaylandırmadan imalat ve saha montajına kadar tüm proje yaşam döngüsünü kapsar. Yarattığımız her bileşende hassasiyet ve dayanıklılık sunuyoruz. Projelerimiz, yapısal performans, malzeme davranışı ve inşaat uygulanabilirliği konularındaki derin anlayışımızı yansıtır.",
            description3: "Endüstriyel, ticari, tarımsal ve belediye sektörlerindeki müşterilerimiz, sadece yapısal olarak sağlam değil, aynı zamanda zaman ve maliyet açısından verimli çelik ve beton sistemler tasarlamamız için bize güveniyor. Güvenlik, sürdürülebilirlik ve inovasyon konusundaki günümüz standartlarını karşılayan yüksek performanslı mühendislik hizmeti sunmaktan gurur duyuyoruz.",
            description4: "SEBA, pratik deneyim, teknik mükemmellik ve dürüstlükle inşa etme taahhüdü üzerine kurulmuştur. İster karmaşık bir çelik yapı tasarımı, ister büyük ölçekli saha montajı yönetimi olsun, her projeye netlik, güvenilirlik ve mühendislik gücü katıyoruz.",
            quote: "\"Sadece yapı inşa etmiyoruz. Güven inşa ediyoruz.\""
        },
        hero: {
